...
import (
	...
	"github.com/papudatta/bookings/internal/repository"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		helpers.ServerError(w, errors.New("Can't get this from session"))
		return
	}
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	if len(rooms) == 0 {
		m.App.Session.Put(r.Context(), "error", "There is no availability for these dates")
...
func (m *Repository) PostShowLogin(w http.ResponseWriter, r *http.Request) {
	...
	m.App.Session.Put(r.Context(), "flash", "You are now logged in :-)")
